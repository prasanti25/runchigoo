...
def structured_response(instruction, data, schema, *, timeout=8, max_tokens=1800):
    ...
    payload = {
        ...
        "generationConfig": {"temperature": 0, "maxOutputTokens": max_tokens, "responseMimeType": "application/json", "responseSchema": schema},
    }
    try:
